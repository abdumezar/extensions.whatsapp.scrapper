...
Required Notice: Copyright 2026 Abdulrhman Mezar (https://github.com/abdumezar)
...
However, you may only distribute the software according to Distribution License and make changes or
new works based on the software according to Changes and New Works License.
...
study, private entertainment, hobby projects, amateur pursuits, or religious observance, without any
...
safety or health organization, environmental protection organization, or government institution is
use for a permitted purpose regardless of the source of funding or obligations resulting from the
funding.
...
work for, plus all organizations that have control over, are under the control of, or are under
common control with that organization. **Control** means ownership of substantially all the assets
of an entity, or the power to direct its management and policies by vote, contract, or otherwise.
...
These terms cover the code in this repository. Vendored third-party files keep their own licences,
which are more permissive than these terms:

- `src/lib/libphonenumber-max.js` — a build of
  [libphonenumber-js](https://github.com/catamphetamine/libphonenumber-js), MIT License.
- `src/assets/fonts/` — Roboto (Apache License 2.0, Google LLC) and IBM Plex Sans Arabic
  (SIL Open Font License 1.1, IBM Corp). See `src/assets/fonts/LICENSE.md`.
- `src/styles/tokens.css` — a generated Material Design 3 colour-role layer, derived with
